...
export default function Transactions() {
  ...
  const handleSubmit = ((e) => {
    ...
    const existingItem = savedTransactions.find(item => item.EmpNo === inputedTransactions.EmpNo && item.CodeName === inputedTransactions.CodeName);
    ...
    if (existingItem) {
      ...
      if (inputedTransactions.toReplace) {
        ...
        if (existingItem.Amt != inputedTransactions.Amt) {
          setSavedTransactions(prevBatches =>
      ...
      setSavedTransactions(prevBatches => [...prevBatches, inputedTransactions]);
    }
  })
      ...
      <div className="overflow-x-auto m-0 p-0">
        <div className="flex flex-col h-[28rem] overflow-y-auto overflow-x-auto bg-slate-200 p-5 m-8 rounded-lg">
          <table className="table overflow-y-auto overflow-x-auto">
            ...
            <tbody>
              {savedTransactions.map((item, index) => (
